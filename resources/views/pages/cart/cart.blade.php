...
@section('content')
    <div class="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <h1 class="text-2xl sm:text-3xl font-bold text-center sm:text-left">Your Cart</h1>
            ...
            @if ($cartItems->count() > 0)
                <div class="hidden sm:flex sm:flex-row justify-end items-stretch sm:items-center gap-2 sm:gap-3">
                    <button
                        ...
                        <span class="hidden sm:inline">Update all</span>
        ...
        @if ($cartItems->count() == 0)
            <div class="text-center py-8 sm:py-12">
                <h2 class="text-xl sm:text-2xl font-semibold text-gray-600 mb-4">Cart is empty</h2>
                <a href="{{ route('home') }}" class="btn btn-neutral">Continue shopping</a>
            </div>
        @else
                                ...
                                <div class="flex items-center gap-3 sm:gap-4 flex-1">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-semibold text-base sm:text-lg mb-2 line-clamp-2">
                                            {{ $cartItem->product->name ?? 'Product does not exist' }}</h3>
                ...
                <div class="lg:col-span-1 sm:justify-self-end lg:justify-self-center">
                    <div
                        ...
                        <div class="card-body p-4 sm:p-6">
                            <h3 class="card-title text-lg sm:text-xl">Order Summary</h3>

                            <div class="space-y-2 mb-4">
                                <div class="flex justify-between text-sm sm:text-base">
                                    <span>Total (<span id="cart-count">{{ count($cartItems) }}</span> products)</span>
    ...
    <dialog id="save-changes-modal" class="modal">
        <div class="modal-box">
            <h3 class="font-bold text-lg mb-4">Save changes before paying?</h3>
            <div class="space-y-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-gray-700 mb-2">You have changed the quantity of some products in your shopping cart.
                        </p>
                        <p class="text-sm text-gray-600">Do you want to save these changes before proceeding to checkout?
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="text-sm font-medium text-blue-800">Note</span>
                    </div>
                    <p class="text-sm text-blue-700">If not saved, the product quantity will return to the original value.
                    </p>
                </div>
            </div>

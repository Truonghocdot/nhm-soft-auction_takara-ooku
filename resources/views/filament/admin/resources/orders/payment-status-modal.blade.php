<div class="space-y-6">
    <div class="bg-gray-50 p-4 rounded-lg">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
                <span class="font-medium text-gray-700">Placement date:</span>
    ...
    <div class="bg-white border rounded-lg">
            ...
            <div class="p-4">
                <div class="grid grid-cols-2 gap-4 text-sm mb-4">
                    ...
                    <div>
                        ...
                        <span
                            class="ml-2 text-gray-900 font-semibold">{{ number_format($payment->amount, 0, ',', '.') }}
                            ₫</span>
                    </div>
                    <div>
                    ...
                    <div>
                        <span class="font-medium text-gray-700">Seller confirmed:</span>
                        <span class="ml-2 text-gray-900">
                            @if (!empty($payment->confirmation_at))
                                At {{ \Carbon\Carbon::parse($payment->confirmation_at)->format('d/m/Y H:i') }}
                            @else
                ...
                @if ($payment->status === 'pending' && $isAdmin)
                    <div class="border-t pt-4">
                        <h4 class="font-medium text-gray-900 mb-3">Confirm payment</h4>
                        <p class="text-sm text-gray-600 mb-4">
                            Confirm that you have received payment from the customer and update the payment status.
                        </p>
        ...
        @else
            <div class="p-4 text-center text-gray-500">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">No payment information available</h3>
                <p class="mt-1 text-sm text-gray-500">This order does not have payment information available.</p>
            </div>
        @endif
    </div>
</div>

<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Current balance</div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Total deposit</div>
        <div class="text-3xl font-bold text-gray-700 dark:text-white">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        <div class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Total amount of product purchased</div>
        <div class="text-3xl font-bold text-gray-700 dark:text-white">
